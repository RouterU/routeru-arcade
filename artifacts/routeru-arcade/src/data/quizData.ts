...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    correctIndex: 0,
    explanation:
      "The gray circle icon in Route Planner signifies a DG_1 customer with no liftgate requirement.",
    difficulty: "new-hire",
    points: 100,
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The blue triangle icon in Route Planner signifies a DG_2 customer with a liftgate requirement.",
    difficulty: "new-hire",
    points: 100,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "The black square icon in Route Planner signifies a key drop or dark delivery.",
    difficulty: "new-hire",
    points: 100,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The green square icon in Route Planner signifies a child account.",
    difficulty: "new-hire",
    points: 100,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "The blue star icon in Route Planner signifies a Recovery Express.",
    difficulty: "new-hire",
    points: 100,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The dark red or maroon star icon in Route Planner signifies a backhaul/pickup.",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "The red star icon in Route Planner signifies a stop is missing SOUS setup (DV).",
    difficulty: "intermediate",
    points: 150,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The yellow diamond icon in Route Planner signifies a published route that was sent to Tandem with no errors.",
    difficulty: "intermediate",
    points: 150,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "The green diamond icon in Route Planner signifies a published route that was sent to Omnitracs with no errors.",
    difficulty: "intermediate",
    points: 150,
    topic: "descartes-route-planner",
  },
  ...
  },
  {
    id: 11,
    question:
      "How can you add options when you right-click on a route, such as printing driver manifests?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      "On the side menu, go to App Setup > UI Setting > Context Menu and select the quadrant you want to edit. The Routes quadrant is where you can add the option to print a driver manifest.",
    difficulty: "expert",
    points: 200,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Before assuming it is a BGO issue, make sure there is not an 'X' in UDFString 4 and check whether 'Exclude From Optimization' is checked inside the resource.",
    difficulty: "expert",
    points: 200,
    topic: "descartes-route-planner",
  },
