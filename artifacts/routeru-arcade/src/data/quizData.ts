...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    correctIndex: 0,
    explanation:
      "The QRG says users should add their market’s Planning, Dispatch, Review, and Archive schedules to Favorites before routing.",
    difficulty: "easy",
    points: 100,
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The QRG describes Planning as the schedule that provides visibility to future orders and routes that have not yet been fully managed by a router.",
    difficulty: "easy",
    points: 100,
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The QRG says to use caution when removing routes and to unassign all stops before reassigning the route to Trash.",
    difficulty: "easy",
    points: 100,
  },
  {
    ...
    options: ["A red diamond", "A yellow route line", "A U marker", "A stop number 0"],
    correctIndex: 2,
    explanation:
      "The QRG states that unassigned stops can be shown on the map and are marked with a 'U'.",
    difficulty: "easy",
    points: 100,
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The QRG instructs routers to wait 15 minutes after cut is taken for BGO to complete before manually moving routes and stops to Review.",
    difficulty: "medium",
    points: 150,
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The QRG says all unassigned stops must either be assigned to a route and published, or—if they are not shipping on the current delivery day—added to a 999 route and published.",
    difficulty: "medium",
    points: 150,
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The QRG notes that if a route will not publish, you should check Route Detail 1 to see whether any orders are still in status 20, which can block publishing.",
    difficulty: "medium",
    points: 150,
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The QRG explains that the first publish sends routes to Tandem and a yellow diamond appears when the send to Tandem is successful.",
    difficulty: "medium",
    points: 150,
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The QRG says a green diamond signifies the publish to Omni was successful.",
    difficulty: "medium",
    points: 150,
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "The QRG states that locking a customer to a route or sequence is maintained in SOUS via Routing Attributes, not directly in Route Planner.",
    difficulty: "hard",
    points: 200,
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The QRG explains that a '50' Preferred Route Position means the customer is dynamic and can move within a route sequence, while still respecting lower sequence locks.",
    difficulty: "hard",
    points: 200,
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The QRG says API Tracking is found under Data > API Tracking > API Tracking and is used to review detailed history of system and user updates.",
    difficulty: "hard",
    points: 200,
  },
];