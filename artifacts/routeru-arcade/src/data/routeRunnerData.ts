...
export const routeRunnerQuestions: RouteRunnerQuestion[] = [
  {
    id: 1,
    question:
      "Before publishing the last route, the map is still showing unassigned stops marked with 'U'. What should happen first?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      "All stops must be accounted for before publish. Non-shipping stops should be placed on a 999 route.",
    difficulty: "new-hire",
    points: 100,
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "A yellow diamond indicates the route was successfully sent to Tandem.",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Persistent route and sequence locks are maintained in SOUS Routing Attributes.",
    difficulty: "expert",
    points: 200,
    topic: "sous",
  },
  {
    id: 4,
    question:
      "A route will not publish and some orders remain in status 20. What should you check?",
    options: [
    ...
    correctIndex: 0,
    explanation:
      "Orders stuck in status 20 can block publishing and should be reviewed in Route Detail.",
    difficulty: "intermediate",
    points: 150,
    topic: "descartes-route-planner",
  },
  {
    id: 5,
    question:
      "After cut is taken, how long should routers generally wait for BGO to complete before moving routes and stops?",
    options: ["5 minutes", "10 minutes", "15 minutes", "30 minutes"],
    correctIndex: 2,
    explanation:
      "Routers should generally wait about 15 minutes after cut for BGO processing to complete.",
    difficulty: "new-hire",
    points: 100,
    topic: "descartes-route-planner",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Under-minimum routes should be reviewed before publish to determine whether they should be consolidated or adjusted.",
    difficulty: "intermediate",
    points: 150,
    topic: "descartes-route-planner",
  },
